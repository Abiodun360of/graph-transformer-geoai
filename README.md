...
![GEE](https://img.shields.io/badge/Google_Earth_Engine-API-green?style=flat-square)
![Colab](https://img.shields.io/badge/Google_Colab-T4_GPU-F9AB00?style=flat-square&logo=googlecolab)
![License](https://img.shields.io/badge/License-MIT-yellow?style=flat-square)
![Status](https://img.shields.io/badge/Status-Research_Complete-brightgreen?style=flat-square)
...
| GATv2 — spatial only (Phase 3) | 99.2% | 0.922 | 0.959 |
| **Graph-Transformer GeoAI (Full)** | **99.73%** | **0.956** | **0.977** |

**The spatial graph reasoning (GATv2) contributed the largest single gain (+12.1% F1)** — confirming that flood risk is a network phenomenon requiring graph-based modelling, not pixel-based classification.
...
Class balance:  96.9% No Risk  |  3.1% Flood Risk
...
│   ├── phase3_gat_training.ipynb          # GATv2 spatial learning (F1=0.922)
│   └── phase4_transformer_training.ipynb  # Temporal Transformer (F1=0.956)
│
├── 📊 outputs/
│   ├── figures/
...
[![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/YOUR_USERNAME/graph-transformer-geoai/blob/main/notebooks/phase1_data_acquisition.ipynb)
...
@article{ofobutu2024graphtransformer,
  ...
  year    = {2024},
  url     = {https://github.com/YOUR_USERNAME/graph-transformer-geoai},
  note    = {Flood F1 = 0.956, Accuracy = 99.73\%}
}
```
